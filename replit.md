...
- July 09, 2025. Transformed conflicting information display from "Different Perspectives" to "Conflicting Info" with clear claim vs counterclaim format. Added schema fields for conflictingClaim and conflictingSources. Updated UI to show green/red color coding for claims vs counterclaims with specific source attribution (e.g., "White House vs Al Jazeera, Rolling Stone, KFF"). Enhanced dummy data with authentic legislative conflicts including tax impact, Medicaid cuts, deficit effects, and immigration enforcement funding disputes
